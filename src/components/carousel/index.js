 ...
 */
// import CarouselPaginationButton from 'components/carousel/CarouselPaginationButton'
...
class Carousel extends Component {
  ...
  getTargetLeft (touchOffset, slide) {
    ...
    let cellAlign = this.props.cellAlign

    if (this.props.breakPoints) {
      for (let point in this.props.breakPoints) {
        if (parseInt(point) >= window.innerWidth && this.props.breakPoints[point].cellAlign) {
          cellAlign = this.props.breakPoints[point].cellAlign
          break
        }
      }
    }
